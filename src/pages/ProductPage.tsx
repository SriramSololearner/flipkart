...
import { StyleSheet } from "../styles/CardStyles";
import assured from "../Assets/fa_62673a.png";
    ...
    <Box sx={StyleSheet.rootContainer}>
      ...
      <Container maxWidth="xl" sx={StyleSheet.Container}>
        <Box sx={StyleSheet.Main}>
          {
            <>
              <Box sx={StyleSheet.btnContainer}>
                <Button onClick={() => navigate(-1)} sx={StyleSheet.Back}>
                  Back
                </Button>
              </Box>
              ...
              <Box sx={StyleSheet.product}>
                <Box>
                  ...
                  />
                  <Box component="div" sx={StyleSheet.btnGrp}>
                    <Button
                      variant="outlined"
                ...
                <Box sx={StyleSheet.prodDetails}>
                  ...
                  <Box sx={StyleSheet.BankOffer}>
                    ...
                    <Typography sx={StyleSheet.offerTxt}>Bank Offer</Typography>
                    <Typography sx={StyleSheet.cardOffer}>
                      10% off on Flipkart Axis Bank Credit Card EMI
